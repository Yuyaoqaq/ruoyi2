    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['bookSys:users:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['bookSys:users:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listUsers, getUsers, delUsers, addUsers, updateUsers } from "@/api/bookSys/users"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('bookSys/users/export', {
        ...this.queryParams
