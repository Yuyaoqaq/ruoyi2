<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="学生邮箱" prop="sEmail">
        <el-input
    ...
    <el-table v-loading="loading" :data="manageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学生班级" align="center" prop="sClass" />
      <el-table-column label="学生学校" align="center" prop="sSchool" />
      <el-table-column label="学生学号" align="center" prop="sNum" />
      <el-table-column label="学生邮箱" align="center" prop="sEmail" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="学生学校" prop="sSchool">
          <el-input v-model="form.sSchool" placeholder="请输入学生学校" />
        </el-form-item>
        <el-form-item label="学生学号" prop="sNum">
          <el-input v-model="form.sNum" placeholder="请输入学生学号" />
        </el-form-item>
        <el-form-item label="学生邮箱" prop="sEmail">
          <el-input v-model="form.sEmail" placeholder="请输入学生邮箱" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除学生信息编号为"' + sIds + '"的数据项？').then(function() {
        return delManage(sIds)
      }).then(() => {
        this.getList()
