...
import com.ruoyi.bookSys.domain.Users;
import com.ruoyi.bookSys.service.IUsersService;
...
public class UsersController extends BaseController
{
     ...
     * 查询用户管理列表
     */
    @PreAuthorize("@ss.hasPermi('bookSys:users:list')")
    @GetMapping("/list")
     ...
     * 导出用户管理列表
     */
    @PreAuthorize("@ss.hasPermi('bookSys:users:export')")
     ...
     * 获取用户管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('bookSys:users:query')")
     ...
     * 新增用户管理
     */
    @PreAuthorize("@ss.hasPermi('bookSys:users:add')")
     ...
     * 修改用户管理
     */
    @PreAuthorize("@ss.hasPermi('bookSys:users:edit')")
     ...
     * 删除用户管理
     */
    @PreAuthorize("@ss.hasPermi('bookSys:users:remove')")
